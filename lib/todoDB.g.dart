...
class _$AppDatabase extends AppDatabase {
    ...
    final databaseOptions = sqflite.OpenDatabaseOptions(
      ...
      onCreate: (database, version) async {
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `ToDoItem` (`id` INTEGER NOT NULL, `itemName` TEXT NOT NULL, PRIMARY KEY (`id`))');
  ...
  @override
  ToDoDAO get dao {
    return _daoInstance ??= _$ToDoDAO(database, changeListener);
  }
}
...
class _$ToDoDAO extends ToDoDAO {
  ...
  @override
  Future<List<ToDoItem>> selectAllToDo() async {
  ...
  @override
  Future<void> insertToDo(ToDoItem t) async {
    await _toDoItemInsertionAdapter.insert(t, OnConflictStrategy.abort);
  }

  @override
  Future<int> updateToDo(ToDoItem t) {
    return _toDoItemUpdateAdapter.updateAndReturnChangedRows(
        t, OnConflictStrategy.abort);
  }

  @override
  Future<int> deleteToDo(ToDoItem t) {
    return _toDoItemDeletionAdapter.deleteAndReturnChangedRows(t);
  }
}
